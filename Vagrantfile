...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "enu-local-dev"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/eaglesandunicorns"
  #   chef.validation_client_name = "eaglesandunicorns-validator"
  #   chef.validation_key_path = ".chef/eaglesandunicorns-validator.pem"
  # end
end
